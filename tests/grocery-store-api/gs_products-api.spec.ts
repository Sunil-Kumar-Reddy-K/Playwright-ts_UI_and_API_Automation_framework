...
test.describe.serial('Products API Tests', () => {
  test('GET All Products API should return status 200 and a list of products',{tag: '@API'}, async ({ request }) => {
  ...
  test('GET Single Product API should return status 200 and product details',{tag: '@API'}, async ({ request }) => {
