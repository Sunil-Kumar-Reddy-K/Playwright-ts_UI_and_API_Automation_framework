...
test.describe("Email Automation - Password Reset Flow", () => {
    ...
    test(
        ...
        async ({ page }) => {
            ...
            await page.locator("//span[@role='alert'][text()='Email Sent!']").isVisible();
    ...
    test("Test Delete Functionality - Cleanup Old Test Emails", { tag: "@emailSend" }, async () => {
    ...
    test("Test Bulk Delete Functionality", { tag: "@emailSend" }, async () => {
    ...
    test("Test Move to Trash vs Permanent Delete", { tag: "@emailSend" }, async () => {
    ...
    test("Debug: Test Gmail Connection and Permissions", { tag: "@emailSend" }, async () => {
